...
public class BingrenController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		BingrenEntity user = bingrenService.selectOne(new EntityWrapper<BingrenEntity>().eq("shoujihao", username));
    ...
    public R register(@RequestBody BingrenEntity bingren){
    	...
    	BingrenEntity user = bingrenService.selectOne(new EntityWrapper<BingrenEntity>().eq("shoujihao", bingren.getShoujihao()));
		if(user!=null) {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,BingrenEntity bingren, HttpServletRequest request){
