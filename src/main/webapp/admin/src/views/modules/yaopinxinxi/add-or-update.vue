          ...
          <el-form-item class="input" label="药品名称" prop="yaopinmingcheng">
              <el-input v-model="ruleForm.yaopinmingcheng" 
                placeholder="药品名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="药品类别" prop="yaopinleibie">
          <el-input v-model="ruleForm.yaopinleibie" 
              placeholder="药品类别" clearable  :readonly="ro.yaopinleibie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="药品类别" prop="yaopinleibie">
              <el-input v-model="ruleForm.yaopinleibie" 
                placeholder="药品类别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
          ...
          <el-form-item class="input" v-if="ruleForm.shengchanriqi" label="生产日期" prop="shengchanriqi">
              <el-input v-model="ruleForm.shengchanriqi" 
                placeholder="生产日期" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="有效期至" prop="youxiaoqizhi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.youxiaoqizhi" 
                type="date"
                placeholder="有效期至">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.youxiaoqizhi" label="有效期至" prop="youxiaoqizhi">
              <el-input v-model="ruleForm.youxiaoqizhi" 
                placeholder="有效期至" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="注意事项" prop="zhuyishixiang">
              <el-input v-model="ruleForm.zhuyishixiang" 
                placeholder="注意事项" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="适用对象" prop="shiyongduixiang">
          <el-input v-model="ruleForm.shiyongduixiang" 
              placeholder="适用对象" clearable  :readonly="ro.shiyongduixiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="适用对象" prop="shiyongduixiang">
              <el-input v-model="ruleForm.shiyongduixiang" 
                placeholder="适用对象" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yaopinmingcheng = true;
            continue;
	            	            ...
	            	            if(o=='yaopinleibie'){
            this.ruleForm.yaopinleibie = obj[o];
	    this.ro.yaopinleibie = true;
            continue;
          }
	            	            if(o=='tupian'){
	    ...
	    this.ro.shengchanriqi = true;
            continue;
	            	            ...
	            	            if(o=='youxiaoqizhi'){
            this.ruleForm.youxiaoqizhi = obj[o];
	    this.ro.youxiaoqizhi = true;
            continue;
          }
	            	            if(o=='zhuyishixiang'){
