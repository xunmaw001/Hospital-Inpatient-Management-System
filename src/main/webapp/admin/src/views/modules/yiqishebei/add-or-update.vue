          ...
          <el-form-item class="input" label="设备类型" prop="shebeileixing">
              <el-input v-model="ruleForm.shebeileixing" 
                placeholder="设备类型" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="用途" prop="yongtu">
          <el-input v-model="ruleForm.yongtu" 
              placeholder="用途" clearable  :readonly="ro.yongtu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="用途" prop="yongtu">
              <el-input v-model="ruleForm.yongtu" 
                placeholder="用途" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="生产商" prop="shengchanshang">
          <el-input v-model="ruleForm.shengchanshang" 
              placeholder="生产商" clearable  :readonly="ro.shengchanshang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="生产商" prop="shengchanshang">
              <el-input v-model="ruleForm.shengchanshang" 
                placeholder="生产商" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="注意事项" prop="zhuyishixiang">
              <el-input v-model="ruleForm.zhuyishixiang" 
                placeholder="注意事项" readonly></el-input>
                                                                                                                                        ...
                                                                                                                                        <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="设备详情" prop="shebeixiangqing">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shebeixiangqing" label="设备详情" prop="shebeixiangqing">
                    <span>{{ruleForm.shebeixiangqing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yiqishebei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yiqishebeiCrossAddOrUpdateFlag = false;
                  this.parent.search();
